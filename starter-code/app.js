...
// The value of "this" when joe.scope() is invoked would be the global object, since the arrow function used in the scope method does not bind its own this value.
// 2. What is "this" when joe.scopeArrow() is invoked?
// The value of "this" when joe.scopeArrow() is invoked would also be the global object, since the arrow function also does not bind its own this value. (Need to write extra stuff becase I forgot to make a branch and I just made one)
// 3. Explain why "this" is different when an arrow function is used.
// The reason "this" is different when an arrow function is used is because arrow functions do not have their own "this" binding. Unlike regular functions, the value of "this" inside an arrow function is determined by the surrounding lexical scope.
